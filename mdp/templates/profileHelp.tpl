...
<div id="texte_formule" class="help">
    Veuillez choisir la formule qui convient: Madame ou Monsieur
</div>
<div id="texte_nom" class="help">
    Veuillez indiquer votre nom de famille (pas de pseudo, svp)
</div>
<div id="texte_prenom" class="help">
...
<div id="texte_passwd" class="help">
    <p>Veuillez choisir un mot de passe. Pour des raisons de sécurité, nous demandons:</p>
    <ul>
        <li>au moins 9 signes (lettres, chiffres, symboles)</li>
...
<div id="texte_passwd2" class="help">
    <p>Veuillez répéter le mot de passe</p>
</div>
