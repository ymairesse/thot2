<form name="parent" id="parent" method="POST" action="index.php" role="form" class="form-vertical" autocomplete="off">
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-12">
            ...
            <h4>Vous êtes</h4>
            <p>
                <strong>{$identite.formule} {$identite.prenom} {$identite.nom}</strong>
            </p>
            <p>Votre nom d'utilisateur:
                <strong>{$identite.userName}</strong>
            </p>

            <p>Votre adresse IP:
                <strong>{$identiteReseau.ip} {$identiteReseau.hostname}</strong>
            </p>
            <p>Nous sommes le
                <strong>{$identiteReseau.date}</strong> à
                <strong>{$identiteReseau.heure}</strong>
            </p>
