                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="date" id="datepicker" value="{$startDate}" placeholder="Date de notification" class="ladate form-control input-sm" autocomplete="off">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="input-group">
                            <input type="text" name="heure" id='heure' value="{$heure|default:$travail.heure}" class="form-control input-sm" autocomplete="off">
        ...
        if ($('#editJdc').valid()){
            ...
            $.post('inc/jdc/saveModalJdc.inc.php', {
                ...
                if (id != 0)
                    ...
                    message: "Événement PAS enregistré!!!"
                })
            });
